    ...
    <div id="top-container">
        <div class="nav-container">
            ...
            <div class="top-item center">
                <div class="item">
                    <el-dropdown trigger="click" @command="handleMore" style="color: #F5F5F7;">
                ...
                <div class="item search-icon-box ">
                    ...
                    <svg v-else t="1577956073687" @click="handleCloseSearchBox" class="icon" viewBox="0 0 1024 1024"
                        ...
                        <path d="M851.416 217.84l-45.256-45.248L512 466.744l-294.152-294.16-45.256 45.256L466.744 512l-294.152 294.16 45.248 45.256L512 557.256l294.16 294.16 45.256-45.256L557.256 512z"
                              fill="#F5F5F7" p-id="1469"></path>
                    </svg>
                </div>
                <div class="item">
                    <el-dropdown trigger="click" @command="handleSourceCode" style="color: #F5F5F7;">
                          <span class="el-dropdown-link">
                            源代码
                        ...
                        <el-dropdown-menu slot="dropdown">
                            <el-dropdown-item command="front">
                                <div style="display: flex; justify-content: center; align-items: center; padding: 5px;">
                                    <svg t="1578390585461" class="icon" viewBox="0 0 1024 1024" version="1.1"
                                         xmlns="http://www.w3.org/2000/svg" p-id="3455" width="24" height="24">
                                    ...
                                    <span style="margin-left: 10px;">前端</span>
                                </div>
                            </el-dropdown-item>
                            <el-dropdown-item command="back">
                                <div style="display: flex; justify-content: center; align-items: center; padding: 5px;">
                                    ...
                                    <span style="margin-left: 10px;">后端</span>
                                </div>
                            </el-dropdown-item>
                        </el-dropdown-menu>
                    </el-dropdown>
...
<script>
    export default {
        ...
        methods: {
            ...
            // 源代码
            handleSourceCode(command) {
                if ('front' === command) {
                    window.location.href = 'https://github.com/cnxiahuajie/library';
                } else if ('back' === command) {
                    window.location.href = 'https://github.com/cnxiahuajie/spring-cloud-vtarm';
                }
            },
            // 前往文章编辑页面
            toArticleEdit() {
...
<style scoped>
    ...
    #top-container .search-box-container input::-webkit-input-placeholder {
        color: #F5F5F7;
    }
