                ...
                <div class="item">
                    <el-dropdown trigger="click"  @command="handleMore" style="color: #C0C4CC;">
                      <span class="el-dropdown-link">
                        图书馆<i class="el-icon-arrow-down el-icon--right"></i>
                      </span>
